...
public class Endpoints {
    ...
    public static final String API_DELETE_COURIER = "/api/v1/courier/{id}";
    public static final String API_DELETE_COURIER_WITHOUT_LOGIN = "/api/v1/courier";
    public static final String API_ORDER_CANCEL = "/api/v1/orders/cancel";
